...
final class RequestActionTest extends WebTestCase
{
    ...
    {
        $this->client->jsonRequest('PUT', '/v1/admin/testing/tests/' . RequestFixture::TEST_ID . '/deactivate');
    ...
    public function testForbiddenForRegularUsers(): void
    {
        $this->client->jsonRequest(
            'PUT',
            '/v1/admin/testing/tests/' . RequestFixture::TEST_ID . '/deactivate',
            [],
    ...
    public function testSuccess(): void
    {
        ...
        self::assertInstanceOf(TestDeactivated::class, $message);

        self::assertEquals(RequestFixture::TEST_ID, $message->id);

        $test = $this->tests->get(new TestId(RequestFixture::TEST_ID));

        self::assertTrue($test->isInactive());
    }

    public function testDeactivateAlready(): void
    {
        $this->client->jsonRequest(
            'PUT',
            '/v1/admin/testing/tests/' . RequestFixture::TEST_INACTIVE_ID . '/deactivate',
            [],
            $this->authHeaders($this->adminToken)
        );
    ...
    public function testNotFound(): void
    {
        $this->client->jsonRequest(
            'PUT',
            '/v1/admin/testing/tests/' . RequestFixture::TEST_NOT_FOUND_ID . '/deactivate',
            [],
            $this->authHeaders($this->adminToken)
        );
    ...
    public function testInvalid(): void
    {
        $this->client->jsonRequest(
            'PUT',
            '/v1/admin/testing/tests/invalid/deactivate',
            [],
            $this->authHeaders($this->adminToken)
        );
