...
namespace App\Http\Action\V1\Admin\Course\Course\GetPaginated;

use App\Course\Query\Course\GetPaginated\Query;
use App\Course\Query\Course\GetPaginated\QueryHandler;
