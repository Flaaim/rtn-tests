...
{
    public const string TASK_ONE_ID = '910d0dbf-6292-4d2a-8c04-9e0c9618d7d4';
    public const string TASK_TWO_ID = '05d7af85-f913-4a95-b22b-06b84a3b4118';
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $taskOne = new Task(
            taskId: new TaskId(self::TASK_ONE_ID),
        ...
        $taskTwo = new Task(
            taskId: new TaskId(self::TASK_TWO_ID),
            parserId: new ParserId(self::PARSER_ID),
            branchId: '000000',
